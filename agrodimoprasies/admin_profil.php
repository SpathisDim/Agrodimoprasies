...
?>
				...
				<p><b> Όνομα:</b><?php echo $row['Onoma_D']; ?>
				</br>
				<p ><b> Επίθετο:</b><?php echo $row['Epitheto_D']; ?>
				</br>
				<p><b> Username:</b><?php echo $row['username_D']; ?>
				</br>
				<p><b>Email:</b><?php echo $row['Email_D']; ?>
				</br>
				<p><b>Ορίστε Νεο Admin:</b><a class="epexergasia_stoixeiwn" href="new_admin.php"><b>->HERE!</b></a>
				</div>
					<div class="epexergasia_stoixeiwn1"><a class="epexergasia_stoixeiwn" href="allagh_stoixeiwn_admin.php"><b>Πατήστε εδώ για αλλαγή των στοιχείων σας!</b></a>
				</div>
 </form>
</div>
</div>	
