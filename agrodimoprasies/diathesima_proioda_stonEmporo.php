...
<div id="field">
	  <form class="modal-content" action="trexouses_dhmoprasies_stonEmporo.php" method="POST">
		<div class="modal-content2">
		 ...
		 <table id="list_products"><!-- pinakas me ta proioda poy eishgage o admin -->
		  ...
		  <?php 
			...
			<div class="clearfix">
					<button type="submit" name="submit_button" class="cancelbtn3">Συμμετοχη σε Δημοπρασία</button>				
			</div>
		</div>
      </form>
	</div>
