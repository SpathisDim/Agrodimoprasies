...
<hr></hr>
			...
			$db=null;
				...
				<p><b> Όνομα:</b><?php echo $row['OnomaE']; ?>
				</br>
				<p ><b> Επίθετο:</b><?php echo $row['EpithetoE']; ?>
				</br>
				<p><b> Username:</b><?php echo $row['usernameE']; ?>
				</br>
				<p><b>Ταχυδρομική διεύθυνση:</b><?php echo $row['T_Dieuthunsh_E']; ?>
				</br>
				<p><b>Τηλέφωνο:</b><?php echo $row['ThlefwnoE']; ?>
				</br>
				<p><b>Email:</b><?php echo $row['Email_Emporou']; ?>
				</br>
				</div>
					<div class="epexergasia_stoixeiwn1"><a class="epexergasia_stoixeiwn" href="allagh_stoixeiwn_emporou.php"><b>Πατήστε εδώ για αλλαγή των στοιχείων σας!</b></a>
					</div>
			</div>  
		</form>
	</div>
