...
<div id="main">
	...
	<div id="field">
		<form class="modal-content" action="" method="POST">
		  <div class="container">
		  <h1>Δημιουργια Διαχειριστη</h1>  
		  <h5>Συμπληρώστε τα πεδία για την δημιουργία admin!!!</h5>
		<hr></hr>
		  </br>
			  <label for="firstname"><b>Όνομα</b></label>
			  <input type="text" placeholder="Oνόμα admin"  name="firstname" required>
			  
			  <label for="laststname"><b>Επώνυμο</b></label>
			  <input type="text" placeholder="Eπίθετο admin"  name="lastname" required>
			  
			  </br>
			  <label for="email"><b>Email</b></label>
			  <input type="text" placeholder="Email admin"  name="email" required>
			  
			  <label for="email"><b>Username</b></label>
			  <input type="text" placeholder="Admin username"  name="username" required>
			  
			  <label for="psw"><b>Password</b></label>
			  <input type="text" placeholder="Admin Password" name="psw" required>
			  ...
			  <input type="password" placeholder="Επιβεβαιωση νεου κωδικου"  name="psw-repeat" required>
			        ...
			        <div class="clearfix">
			   <button type="submit" name="signupbtn" class="signupbtn">Δημιουργια</button></div>
...
try{	
	...
	if(isset($_POST['signupbtn'])){
		...
		$stmt = $db->prepare('INSERT INTO diaxeirisths(Email_D,Onoma_D,Epitheto_D,username_D,password_D)
							VALUES(:Email_D,:Onoma_D,:Epitheto_D,:username_D,:password_D)');
		$Email_D=$_POST["email"];
